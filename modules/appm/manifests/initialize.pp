...
define appm::initialize ($repo, $version, $service, $local_dir, $target, $mode, $owner,) {
  ...
  file {
    "/${local_dir}/wso2${service}-${version}.zip":
      ...
      source => ["puppet:///modules/appm/wso2${service}-${version}.zip", "puppet:///packs/wso2${service}-${version}.zip"],
